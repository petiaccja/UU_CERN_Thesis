...
\usepackage{listings}
\usepackage{xcolor}
\usepackage[a4paper, total={16cm, 23.7cm}, bindingoffset=0mm]{geometry}
...
% TITLE
%----------------------------------------------------------------------------
\newgeometry{left=1cm, right=1cm, top=1cm, bottom=1cm, noheadfoot, nomarginpar}
\begingroup
\thispagestyle{empty}
...
\begin{minipage}[t][0.99\textheight]{0.25\textwidth}\vspace{0pt}%
	\begin{center}
		\includegraphics[width=\textwidth]{uu_logo_color.png}
	\end{center}
\end{minipage}}%
\hfill
\begin{minipage}[t][0.99\textheight]{0.70\textwidth}\vspace{0pt}%
	\begin{flushright}
		\sffamily
		Examensarbete 45 hp\\
		Februari 2020		
	...
	\begin{adjustwidth}{1cm}{1cm}
		\sffamily
		\LARGE Performance optimization of the online data processing software of a high-energy physics experiment
	...
	\vfill
	{
		...
		\begin{flushright}
			...
			\noindent\rule[0.5ex]{0.54\linewidth}{1pt}
...
\newgeometry{left=17mm, right=15mm, top=1cm, bottom=1cm, noheadfoot, nomarginpar}
\begingroup
\thispagestyle{empty}
\setlength{\topskip}{0pt}
\setlength{\parindent}{0pt}

\begin{minipage}[t][0.99\textheight]{42mm}\vspace{0pt}%
	\begin{center}
		\includegraphics[width=\textwidth]{uu_logo_color.png}
	\end{center}
	...
	\scriptsize
	\begin{flushleft}		
		\textbf{Teknisk- naturvetenskaplig fakultet}\\
		\textbf{UTH-enheten}
		\vspace{0.8pc}
...
\end{minipage}%
\hfill
\begin{minipage}[t][0.99\textheight]{122mm}\vspace{0pt}%
	\section*{Abstract}
	{
		\setstretch{0.4}
		\sffamily
		\large \textbf{Performance optimization of the online data processing software of a high-energy physics experiment}

		\noindent\rule[0.5ex]{\linewidth}{1pt}

		\vspace{0.35cm}
		\normalsize \textbf{\textit{Péter Kardos}}
	}
	\vspace{1.5cm}
