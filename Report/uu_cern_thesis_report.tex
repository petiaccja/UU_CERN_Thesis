...
The improvements mentioned in \ref{sec_data_model_possible_improvements} have been implemented by the rest of the team and led to exception improvements in throughput with no compromise on physics performance.
...
\begin{itemize}
	...
	\item Upstream track: interacts with the VELO and the UT/TT
	\item Long track: interacts with all three of the VELO, UT/TT and FT
	\item Downstream track: interacts with the UT/TT and the FT (e.g. particle decay products from displaced secondary vertices)
