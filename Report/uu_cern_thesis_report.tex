...
\begin{center}
	...
	\Huge \textbf{Performance optimization of the online data processing software of a high-energy physics experiment}

	\vspace{2pc}
	\Large \textbf{by}

	\Large \textbf{Péter Kardos}

	\vspace{2pc}
	\large Master's Programme in Computational Science

	\large Department of Information Technology

	\large Uppsala University, 2018-2020

	\vfill
	\textcopyright \;Péter Kardos 2020
\end{center}
